  ...
  describe "play" do
    ...
    context "1 player" do
      ...
      context "wrong answers" do
        it "correctly sums the points" do
          start_game
      ...
      context "right answers" do
        it "correctly sums the points" do
          ...
          Game.last.scores.first.should eq(maximum_score)
        end
      end
    end
    ...
    context "2 players" do
      ...
      context "right answers" do
        it "correctly sums the points" do
          ...
          player1_questions = @quiz.questions.each_with_index { |_, idx| idx.even? }
          total_score_1 = player1_questions.inject(0) { |sum, q| sum += question.points }
          player2_questions = @quiz.questions.each_with_index { |_, idx| idx.odd? }
          total_score_2 = player2_questions.inject(0) { |sum, q| sum += question.points }

          Game.last.scores.should eq([total_score1, total_score2])
        end
      end
    end
  end
