...
Postoji 4 vrste pitanja, poredani prema najlakše do najteže za riješiti, to su:
...
tvrdnja, a korisnik mora odgovoriti označiti je li točna ili netočna tako da
označi odgovor. Ova vrsta pitanja je najlakša zato što je šansa da korisnik
točno odgovori 50\%.
...
postavlja pitanje na koje treba odgovoriti \textbf{jednim} od ponuđenih odgovora
tako da označi odgovor. Ova vrsta pitanja je teža od \emph{točno/netočno} jer se
šansa da korisnik točno odgovori smanjuje s brojem ponuđenih odgovora.

Razmišljali smo o tome da omogućimo više mogućih točnih odgovora, ali to bi
činilo ovu vrstu pitanja težom, pa smo odlučili tu značajku ostaviti kao
mogućnost za buduću verziju aplikacije.
...
Ove tehnologije izvršavaju web preglednici, te su oni jedinstveni, odnosno
nemaju alternativa. Specifikaciju ovih tehnologija donosi internacionalna
organizacija W3C (World Wide Web Consortium).

\subsubsection{HTML}

HTML je prezentacijski jezik koji se koristi za izradu sadržaja web stranica.

Za našu aplikaciju koristili smo najnoviju verziju HTML-a -- HTML5.

\subsubsection{CSS}

CSS je stilski jezik koji se koristi za opis prezentacije HTML dokumenta. Svaka
vrsta web preglednika ga interpretira malo drukčije, te je zato izazovno
napisati CSS na način da isto izgleda u svim web preglednicima.
