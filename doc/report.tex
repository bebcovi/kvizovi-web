...
% opisati faze kao što je napisano (kemijskom) u 4. poglavlju
% prebaciti paragraf iz zaključka gdje već treba
...
\begin{figure}[H]
  \centering
  \includegraphics{school/comparison}
...
\begin{figure}[H]
  \centering
  \includegraphics{student/interesting}
...
\begin{figure}[H]
  \centering
  \includegraphics{student/effective}
  \caption{Učinkovitost učenicima}
  \label{fig:student/effective}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{student/help}
...
određeni cilj. Iako aplikaciju mogu koristiti korisnici koji nisu najvještiji
u korištenju web aplikacija, vjerujemo da svi korisnici više vole učiti iz
prakse a ne čitati upute, i da aplikaciju možemo učinit dovoljno jednostavnom
da je pristupačna za svaki uzrast i stupanj informatičke obrazovanosti.
