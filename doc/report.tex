...
% izmjeniti naslov
% napisati sažetke
% dopuniti zaključak i maknuti citat
...
aplikaciji GitHub\footnote{\url{https://github.com/twin/kvizovi}} pod MIT
licencom, što znači da bilo tko može vidjeti kako aplikacija funkcionira,
doprinijeti aplikaciji na bilo koji način, pa čak i napraviti svoju kopiju
aplikacije i razvijati ju u svom smijeru.\cite{github,mit}
...
svakog HTML elementa u slučaju da web dizajner nije definirao svoja.
...
što omogućuje grupno rješavanje kvizova.
