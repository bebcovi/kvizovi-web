...
slušajući predavanja. Učenici rješavanje kvizova mogu gledati kao na igru, što
pozitivno utječe na usvajanje znanja.

Druga pretpostavka bila je da će profesorima ispitivanje učenika pomoću
aplikacije za kvizove biti jednostavnije nego ispitivanje na tradicionalne
...
profesori unijeli. A može biti informativnije zato što profesori imaju pristup
podacima o učenicima.
...
U 2. smo fazi aplikaciju dali na korištenje u 5 testnih škola te je u njoj
sudjelovalo 5 profesora hrvatskoga jezika i 254 učenika. Na kraju ove faze
proveli smo i anketiranje čije rezultate ćemo prikazati detaljnije u ovom
poglavlju. Napominjemo da smo svjesni malog uzorka testnih ispitanika, no nama
su njihovi odgovori bili od velike pomoći za daljnji rad na aplikaciji,
njezinom usavršavanju i dorađivanju ali i kao barem okviran uvid u
iskoristivost našeg projekta.
...
U ovoj su anketi (vidi prilog \ref{sec:schoolsurv}) sudjelovali svi profesori iz našeg testnog uzorka. Iako nitko
od nastavnika nije primijetio značajno poboljšanje znanja, upotreba aplikacije
je ipak doprinijela njihovoj povećanoj zainteresiranosti za materiju koju su
obrađivali (slika \ref{fig:school/advance}).

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{school/advance}
  \caption{Napredak učenika}
  \label{fig:school/advance}
\end{figure}

Isto tako, primjećeno je i bolje poznavanje gradiva kod učenika koji su
koristili aplikaciju u odnosu na one koji je nisu koristili (slika
\ref{fig:school/comparison}).

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{school/comparison}
  \caption{Usporedba učenika koji su koristili aplikaciju s onima koji nisu}
  \label{fig:school/comparison}
\end{figure}

Rezultati prikazani u slici \ref{fig:school/help} potvrđuju našu hipotezu 1 (da
će upotreba aplikacije pridonijeti većoj zainteresiranosti za gradivo i bolje
usvajanje istoga), odnosno opravdava samu izradu i primjenu ovakve aplikacije u
školama 21. stoljeća.

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{school/help}
...
Od 254 učenika iz testnog uzorka, njih 30 je sudjelovalo u završnoj anketi (vidi
prilog\ref{sec:studentsurv}). Prema dobivenim podatcima, učenici većinom
smatraju da je ovakav način učenja ne samo zanimljiv već i učinkovit i doprinosi
boljem razumijevanju gradiva ali i većem interesu za gradivo (slike
\ref{fig:student/interesting}, \ref{fig:student/effective} i
\ref{fig:student/help}). Čak se osjećaju i puno samouvjerenije na stvarnom satu
prilikom ispitivanja gradiva na klasični način (slika \ref{fig:student/help}).

Čak više od 50\% učenika koji su koristili aplikaciju primijetilo je i napredak
u ocjeni (slika \ref{fig:student/grades}).

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{student/interesting}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{student/effective}
  \caption{Učinkovitost učenicima}
  \label{fig:student/effective}
\end{figure}

\begin{figure}[H]
  \includegraphics[scale=0.6]{student/help}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{student/grades}
...
učenicima da bolje savladaju gradivo (čak više od 50\% ima ih veću ocjenu) a i
...
a ne čitati upute, i da aplikaciju možemo učiniti dovoljno jednostavnom da je
...
\section{Pitanja profesorima}
\label{sec:schoolsurv}

\begin{figure}[H]
  \includegraphics[height=0.6\textheight, clip=true, trim=0 0 0 0, fbox]{school/survey1}
  \caption{Škole -- anketa (prvi dio)}
  \label{fig:schoolsurv1}
\end{figure}

\begin{figure}[H]
  \includegraphics[height=0.9\textheight, clip=true, trim=0 0 0 0, fbox]{school/survey2}
  \caption{Škole -- anketa (drugi dio)}
  \label{fig:schoolsurv2}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[height=0.85\textheight, clip=true, trim=0 0 0 0, fbox]{school/survey3}
  \caption{Škole -- anketa (treći dio)}
  \label{fig:schoolsurv3}
\end{figure}

\section{Pitanja učenicima}
\label{sec:studentsurv}

\begin{figure}[H]
  \includegraphics[height=0.85\textheight, clip=true, trim=0 0 0 0, fbox]{student/survey1}
  \caption{Učenici -- anketa (prvi dio)}
  \label{fig:studentsurv1}
\end{figure}

\begin{figure}[H]
  \includegraphics[height=\textheight, clip=true, trim=0 0 0 0, fbox]{student/survey2}
  \caption{Učenici -- anketa (drugi dio)}
  \label{fig:studentsurv2}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[height=0.9\textheight, clip=true, trim=0 0 0 0, fbox]{student/survey3}
  \caption{Učenici -- anketa (treći dio)}
  \label{fig:studentsurv3}
\end{figure}
...
Quizzes as an alternative way of learning
...
teachers in schools to make quizzes for their students connected with the matter
they're teaching. Students can play quizzes made by their school, and teachers
can monitor the results of the played quizzes, the quality of questions and
answers etc. Hypothesis of the research is that for students this way of
learning will be more interesting and will make them more interested in the
matter in general.
...
noticed improvement of their students, as well as a general raise in interest of
students for the matter.
